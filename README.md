...
> A collection of high-performance Chrome Extensions for productivity, focus enforcement, clipboard management, network monitoring, sticky notes, and browsing research.

---

## Direct Download Center

Click any link below to download the ready-to-install ZIP archive for Google Chrome:
...
| **internet-memory** | AI Research Search, Bookmark & Browsing Timeline | [Download internet-memory ZIP](https://github.com/heyysvm/Chrome-Extensions-/raw/main/internet-memory-v1.0.0.zip) |

---

## Installation Guide (3 Steps)

1. **Download ZIP**: Click any download link in the table above to download the `.zip` archive.
2. **Extract Archive**: Extract the downloaded `.zip` file on your computer.
3. **Load in Chrome**:
...
- **Key Features**:
  ...
  - **1-Click Copy & Actions**: Dedicated copy, pin, and delete buttons on every item.
  - **Text Transformers**: Strip HTML, case conversion (UPPERCASE, lowercase, Title Case), JSON formatter, and AI prompt prependers.

---

### 2. [Fokas](./Fokas) — Focus, Timer, Floating Notes & Cat Companion
...
### 3. [NetSpeedTracker](./NetSpeedTracker) — Real-Time Network Monitor
...
### 4. [Notes_ext](./Notes_ext) — Quick Sticky Notes
...
### 5. [internet-memory](./internet-memory) — AI Browsing Memory & Timeline
